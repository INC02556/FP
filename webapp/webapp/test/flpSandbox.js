		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chop Chop",
									"targetURL": "#fpchopchopwebapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fpchopchopwebapp-display": {
								"semanticObject": "fpchopchopwebapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fpchopchop.webapp",
									"url": sap.ui.require.toUrl("fpchopchop/webapp")
								}
							}
						}
					}
